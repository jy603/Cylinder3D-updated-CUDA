...
def main(args):
    ...
    with torch.no_grad():
        for i_iter_demo, (_, demo_vox_label, demo_grid, demo_pt_labs, demo_pt_fea) in enumerate(
            ...
            # edit byt JH 01/27/23: print predict labels -------------
            #print(np.unique(predict_labels, return_counts=True))
            #print(torch.unique(demo_label_tensor,return_counts=True))
            #print(loss)
            # --------------------------------------------------------
...
if __name__ == '__main__':
    ...
    parser.add_argument('-y', '--config_path', default='../config/adaptive_z_thresholding/rellis-3d_test.yaml')
